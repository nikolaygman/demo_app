		...
		<div class="col-md-6">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<span class="label label-default">Grab</span> <span
						class="label label-default">horror</span> <span
						class="label label-default">horror</span> <span
						class="label label-default">immediately</span> <span
						class="label label-default">horror</span> <span
						class="label label-default">horror</span> <span
						class="label label-default">horror</span>
				</div>
				<div class="col-md-12" id="book-authors">
					Authors:
					<c:forEach items="${book.authors}" var="author">
						<c:out value="${author.author_name}" />
					</c:forEach>
				</div>
				<div class="row">
					<div class="col-md-5" id="book-order-btn">
						...
						<button type="button" class="btn btn-default" data-toggle="modal"
							...
							data-id="${book.id}" onclick="updateOrder(this)">Buy</button>
